System.register(['angular2/core', 'app/shared/modal-window/modal-window.service', 'app/shared/modal-window/modal-window.directive', 'app/shared/modal-window/modal-window-close.directive', 'app/play/shared/choose-resources/choose-resources.component'], function(exports_1, context_1) {
    ...
    var PANEL_ID, CardYearOfPlentyChooseResourcesPanelComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            PANEL_ID = 'CARD_YEAR_OF_PLENTY';
            CardYearOfPlentyChooseResourcesPanelComponent = (function () {
                function CardYearOfPlentyChooseResourcesPanelComponent(_modalWindow) {
                    this._modalWindow = _modalWindow;
                    this.modalWindowId = PANEL_ID;
                }
                CardYearOfPlentyChooseResourcesPanelComponent.prototype.isModalWindowVisible = function () {
                    return this._modalWindow.isVisible(this.modalWindowId);
                };
                CardYearOfPlentyChooseResourcesPanelComponent = __decorate([
                    core_1.Component({
                ...
                return CardYearOfPlentyChooseResourcesPanelComponent;
                var _a;
            }());
            exports_1("CardYearOfPlentyChooseResourcesPanelComponent", CardYearOfPlentyChooseResourcesPanelComponent);
        }
    }
});
