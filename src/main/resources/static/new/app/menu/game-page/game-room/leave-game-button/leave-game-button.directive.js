System.register(['angular2/core', 'angular2/router', 'app/shared/services/remote/remote.service', 'app/shared/alert/alert.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            LeaveGameButtonDirective = (function () {
                function LeaveGameButtonDirective(_remote, _router, _alert) {
                    this._remote = _remote;
                    this._router = _router;
                    this._alert = _alert;
                }
                LeaveGameButtonDirective.prototype.onClick = function () {
                    var _this = this;
                ...
                LeaveGameButtonDirective = __decorate([
                    core_1.Directive({
                ...
                return LeaveGameButtonDirective;
                var _a, _b;
            }());
            exports_1("LeaveGameButtonDirective", LeaveGameButtonDirective);
        }
    }
});
