...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("catan.domain.model");
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("hibernate.hsqldb.write_delay", environment.getRequiredProperty("hibernate.hsqldb.write_delay"));
