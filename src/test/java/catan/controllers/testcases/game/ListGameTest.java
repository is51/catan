...
public class ListGameTest extends GameTestUtil {
    ...
    public void should_get_public_games_list_with_special_parameters() {
        ...
        given()
                ...
                .body("[0].dateCreated", is(both(greaterThan(now - 1200000)).and(lessThanOrEqualTo(now))))
                ...
                .body("[1].dateCreated", is(both(greaterThan(now - 1200000)).and(lessThanOrEqualTo(now))))
        ...
        assertThat("Date of game creation should be equal to or less than current time but not less than 60 seconds",
                firstGameDetails.getDateCreated(), is(both(greaterThan(now - 120000)).and(lessThan(now))));
        ...
        assertThat("Date of game creation should be equal to or less than current time but not less than 60 seconds",
                secondGameDetails.getDateCreated(), is(both(greaterThan(now - 120000)).and(lessThan(now))));
