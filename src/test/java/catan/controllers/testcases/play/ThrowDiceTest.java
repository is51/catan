...
public class ThrowDiceTest extends PlayTestUtil {
    ...
    public void should_correctly_give_resources_to_players() {
        playPreparationStageAndBuildCity()
                ...
                .gameUser(1).logWithCode("THROW_DICE").hasMessage("You threw 6 and got 4 cables, 1 consultant").isDisplayedOnTop()
                .gameUser(1).logWithCode("END_TURN").hasMessage("You ended turn").isHidden()
                .getGameDetails(2)
                .gameUser(2).resourcesQuantityChangedBy(0, 0, 0, 0, 1)
                .gameUser(2).logWithCode("THROW_DICE").hasMessage(scenario.getUsername(1) + " threw 6. You got 1 consultant").isDisplayedOnTop()
                .gameUser(2).logWithCode("END_TURN").hasMessage(scenario.getUsername(1) + " ended turn").isHidden()
                .getGameDetails(3)
                .gameUser(3).resourcesQuantityChangedBy(0, 0, 0, 0, 1)
                .gameUser(3).logWithCode("THROW_DICE").hasMessage(scenario.getUsername(1) + " threw 6. You got 1 consultant").isDisplayedOnTop()
                .gameUser(3).logWithCode("END_TURN").hasMessage(scenario.getUsername(1) + " ended turn").isHidden()
                ...
                .gameUser(1).logWithCode("THROW_DICE").hasMessage(scenario.getUsername(2) + " threw 4. You got 2 consultants").isDisplayedOnTop()
                .gameUser(1).logWithCode("END_TURN").hasMessage(scenario.getUsername(2) + " ended turn").isHidden()
                .getGameDetails(2)
                .gameUser(2).resourcesQuantityChangedBy(0, 0, 0, 0, 0)
                .gameUser(2).logWithCode("THROW_DICE").hasMessage("You threw 4").isDisplayedOnTop()
                .gameUser(2).logWithCode("END_TURN").hasMessage("You ended turn").isHidden()
                .getGameDetails(3)
                .gameUser(3).resourcesQuantityChangedBy(0, 0, 0, 0, 0)
                .gameUser(3).logWithCode("THROW_DICE").hasMessage(scenario.getUsername(2) + " threw 4").isDisplayedOnTop()
                .gameUser(3).logWithCode("END_TURN").hasMessage(scenario.getUsername(2) + " ended turn").isHidden()
                ...
                .gameUser(1).logWithCode("THROW_DICE").hasMessage(scenario.getUsername(3) + " threw 7 and activate hacker").isDisplayedOnTop()
                .gameUser(1).logWithCode("END_TURN").hasMessage(scenario.getUsername(3) + " ended turn").isHidden()
                .getGameDetails(2)
                .gameUser(2).resourcesQuantityChangedBy(0, 0, 0, 0, 0)
                .gameUser(2).logWithCode("THROW_DICE").hasMessage(scenario.getUsername(3) + " threw 7 and activate hacker").isDisplayedOnTop()
                .gameUser(2).logWithCode("END_TURN").hasMessage(scenario.getUsername(3) + " ended turn").isHidden()
                .getGameDetails(3)
                .gameUser(3).resourcesQuantityChangedBy(0, 0, 0, 0, 0)
                .gameUser(3).logWithCode("THROW_DICE").hasMessage("You threw 7 and activate hacker").isDisplayedOnTop()
                .gameUser(3).logWithCode("END_TURN").hasMessage("You ended turn").isHidden()
        ;
    }
