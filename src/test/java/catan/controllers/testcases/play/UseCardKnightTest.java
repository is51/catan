...
public class UseCardKnightTest extends PlayTestUtil {
    ...
    public static final String USER_NAME_1 = "user1_UseCardKnightTest";
    public static final String USER_PASSWORD_1 = "password1";
    public static final String USER_NAME_2 = "user2_UseCardKnightTest";
    public static final String USER_PASSWORD_2 = "password2";
    public static final String USER_NAME_3 = "user3_UseCardKnightTest";
    ...
    @Test
    public void should_successfully_use_card_knight_even_if_player_has_not_thrown_the_dice() {
        playPreparationStageAndBuyCardKnight()
                .END_TURN(1)
    ...
    public void should_fail_if_player_bought_the_card_in_the_current_move() {
        playPreparationStageAndBuyCardKnight()
                .startTrackDevCardsQuantity()
                .USE_CARD_KNIGHT(1).failsWithError("CARD_BOUGHT_IN_CURRENT_TURN")
                .getGameDetails(1)
    ...
    public void should_fail_if_player_already_used_some_card_in_the_current_move() {
        playPreparationStageAndBuyCardKnight()
                ...
                .startTrackDevCardsQuantity()
                .USE_CARD_KNIGHT(1).failsWithError("CARD_ALREADY_USED_IN_CURRENT_TURN")
                .getGameDetails(1)
                    .gameUser(1).devCardsQuantityChangedBy(0, 0, 0, 0, 0)
                    .gameUser(1).doesntHaveAvailableAction("MOVE_ROBBER")
                    .gameUser(1).hasUsedKnights(0);
    ...
    public void should_fail_if_player_does_not_have_the_card() {
        playPreparationStage()
                .startTrackDevCardsQuantity()
                .USE_CARD_KNIGHT(1).failsWithError("ERROR")
                .getGameDetails(1)
                    .gameUser(1).devCardsQuantityChangedBy(0, 0, 0, 0, 0)
                    .gameUser(1).doesntHaveAvailableAction("MOVE_ROBBER")
                    .gameUser(1).hasUsedKnights(0);
    ...
    private Scenario playPreparationStageAndBuyCardKnightAndPassCycle() {
        return playPreparationStageAndBuyCardKnight()
                .END_TURN(1)
    ...
    private Scenario playPreparationStageAndBuyCardKnight() {
