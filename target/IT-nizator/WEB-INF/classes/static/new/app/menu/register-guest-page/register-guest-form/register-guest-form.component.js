System.register(['angular2/core', 'app/shared/services/auth/auth.service', 'app/shared/alert/alert.service'], function(exports_1, context_1) {
    ...
    var RegisterGuestFormComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            RegisterGuestFormComponent = (function () {
                function RegisterGuestFormComponent(_auth, _alert) {
                    this._auth = _auth;
                    this._alert = _alert;
                    this.data = {
                        username: ''
                ...
                RegisterGuestFormComponent.prototype.submit = function () {
                    var _this = this;
                    this._auth.registerAndLoginGuest(this.data.username)
                        ...
                        .catch(function (data) { return _this._alert.message('Registration guest error: ' + ((data.errorCode) ? data.errorCode : 'unknown')); });
                };
                RegisterGuestFormComponent = __decorate([
                    core_1.Component({
                ...
                return RegisterGuestFormComponent;
                var _a, _b;
            }());
            exports_1("RegisterGuestFormComponent", RegisterGuestFormComponent);
        }
    }
});
