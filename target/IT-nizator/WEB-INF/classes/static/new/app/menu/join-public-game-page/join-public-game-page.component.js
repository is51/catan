System.register(['angular2/core', 'angular2/router', 'app/menu/shared/games-list/games-list.component'], function(exports_1, context_1) {
    ...
    var JoinPublicGamePageComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            JoinPublicGamePageComponent = (function () {
                function JoinPublicGamePageComponent() {
                }
                JoinPublicGamePageComponent = __decorate([
                    core_1.Component({
                ...
                ], JoinPublicGamePageComponent);
                return JoinPublicGamePageComponent;
            }());
            exports_1("JoinPublicGamePageComponent", JoinPublicGamePageComponent);
        }
    }
});
